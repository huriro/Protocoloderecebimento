...
public class DatasetUsuario {
    ...
    public DatasetUsuario(String id, String nome, String imagem, String email, String funcao, String telefone, String condominios, String Senha,String imagemusuario) {
        this.id = id;
        this.nome = nome;
        this.imagem = imagem;
        this.Email = email;
